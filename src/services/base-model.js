...
export default {
    ...
    format(message, parameters, isEncoded) {
        ...
        if (parameters) {
            ...
            for (var i = 0; i < allPropertyNames.length; i++) {
                message = message.replace("{" + allPropertyNames[i] + "}", isEncoded ? decodeURIComponent(jsonObject[allPropertyNames[i]]) : jsonObject[allPropertyNames[i]]);
            }
        }
        return message;
    },
    ...
    return_group_card(cardTypeCode, cardBackgroundImageCode) {
        ...
        if (cardTypeCode == '04') {
            ...
            groupCard = 'atmPhu';
        } else if (cardTypeCode == '01' || cardTypeCode == '02' || cardTypeCode == '03' || cardTypeCode == '08' || cardTypeCode == '09' || cardTypeCode == '10' || cardTypeCode == '11' || cardTypeCode == '12' || cardTypeCode == '13' || cardTypeCode == '14' || cardTypeCode == '15' || cardTypeCode == '16' || cardTypeCode == '17' || cardTypeCode == '18' || cardTypeCode == '19' || cardTypeCode == '20' || cardTypeCode == '21' || cardTypeCode == '22' || cardTypeCode == '23' || cardTypeCode == '24' || cardTypeCode == '25' || cardTypeCode == '26' || cardTypeCode == '27' || cardTypeCode == '28' || cardTypeCode == '29' || cardTypeCode == '30' || cardTypeCode == '31' || cardTypeCode == '32' || cardTypeCode == '33') {
            groupCard = 'atmQuy';
            ...
            groupCard = 'MCDB';
        } else if (cardTypeCode == 'VSP' || cardTypeCode == 'VSP1' || cardTypeCode == 'VSP2' || cardTypeCode == 'VSPDN' || cardTypeCode == 'VSPDN1' || cardTypeCode == 'VSPLK' || cardTypeCode == 'VSPMAN' || cardTypeCode == 'VSPSCB' || cardTypeCode == 'VSCP') {
            ...
            groupCard = 'MDT';
        } else if (cardTypeCode.substr(0, 3) == 'VSD' && cardTypeCode.substr(0, 5) != "VSDGT") {
            if (cardBackgroundImageCode != undefined && cardBackgroundImageCode != "00") {
    ...
    convertFloatToString(value, defaule = " 0", num) {
        let number = num > 0 || num === 0 || num === "0" ? parseFloat(value).toFixed(num) : value
        if (value) {
            let newText = ""
            let text = number;
            let _add = 0;
